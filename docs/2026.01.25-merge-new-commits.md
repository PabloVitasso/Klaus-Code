...
| --------- | ------------------ | ------ | --------- |
| 953c7773c | zh-TW translations | 🟢 LOW | ✅ MERGED |
| b472c1522 | Settings UI fix    | 🟢 LOW | ✅ MERGED |
...
| Commit    | Description          | Risk      | Status    |
| --------- | -------------------- | --------- | --------- |
| c28478eda | MCP wildcard support | 🟡 MEDIUM | ✅ MERGED |

**Files Changed:** ~5 files (auto-merged cleanly)
**Tests:**

- MCP Hub tests: 47/47 ✅
- Claude Code tests: 44/44 ✅
- Type check: passed ✅
...
| Commit    | Description          | Risk      | Status    |
| --------- | -------------------- | --------- | --------- |
| c56f0f43c | Worktree UI overhaul | 🟡 MEDIUM | ✅ MERGED |
...
- Fixed import paths in new WorktreeSelector component (`@roo-code/types` → `@klaus-code/types`)
...
- Claude Code tests: 44/44 ✅
- MCP Hub tests: 47/47 ✅
- WorktreeSelector tests: 18/18 ✅

**VSIX Build:** `bin/klaus-code-3.43.0.vsix` ✅
...
1. Import path fix: `@roo-code/types` → `@klaus-code/types` in WorktreeSelector.tsx and spec file
...
- ✅ No "@roo-code" imports in TypeScript files (fixed in WorktreeSelector)
