...
import type { ClineAsk, ToolProgressStatus, ToolGroup, ToolName, GenerateImageParams } from "@klaus-code/types"
...
export type NativeToolArgs = {
	...
	read_file: import("@klaus-code/types").ReadFileToolParams
