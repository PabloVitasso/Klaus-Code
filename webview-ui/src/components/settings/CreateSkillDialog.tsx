...
import { validateSkillName as validateSkillNameShared, SkillNameValidationError } from "@klaus-code/types"
...
/**
 * Validate skill name using shared validation from @klaus-code/types.
